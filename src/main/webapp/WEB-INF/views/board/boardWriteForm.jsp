...
<div class="d-flex justify-content-between mx-4 mt-2"
	...
	<span><input disabled="true" type="submit" id="complete" value="완료" form="boardWriteForm" class="btn btn-sm btn-danger"></input> </span>
</div>
<hr style="margin: 0px;">
<div class="donut">
	...
	<div class="board" style="margin: 1rem 1rem 0.5rem 1rem;">
		<form id="boardWriteForm" method="post" action="boardWrite" enctype="multipart/form-data">
			<table class="table table-striped"
				...
				<thead>
					<tr>
						<th><input type="text" class="form-control" id="title"
