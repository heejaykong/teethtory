...
<body>
	...
	<div class="list-group">
		...
		<a href="#" class="list-group-item list-group-item-action">
			...
			<div>의사선생님 최고에요!!!! 광고 좀 하셨으면 좋겠는데 ㅠ.ㅠ 치료때문에 계속 다니고 있는데 늘
				만족합니다:)</div>
			<div>
				<small><img src="/images/submit.png" style="width: 10px;"></small>
				<small>roketmissile</small> <small>NaN NaN NaN</small> <small>NAVER</small>
